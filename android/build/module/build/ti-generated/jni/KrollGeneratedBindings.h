	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"fr.dzzd.glsprite.GlspriteModule", ::fr::dzzd::glsprite::GlspriteModule::bindProxy, ::fr::dzzd::glsprite::GlspriteModule::dispose},
				{"fr.dzzd.glsprite.ExampleProxy", ::fr::dzzd::glsprite::glsprite::ExampleProxy::bindProxy, ::fr::dzzd::glsprite::glsprite::ExampleProxy::dispose}
			};
